				...
				<form method="post" id="settingsForm" action="<?php echo $wpl_form_action; ?>">
					...
					<div class="postbox" id="UpdateOptionBox"
						...
						<div class="inside">
							...
							<!-- ## BEGIN PRO ## -->
							<label for="wpl-option-handle_stock" class="text_label"><?php echo __('Sync inventory','wplister') ?></label>
							<select id="wpl-option-handle_stock" name="wpl_e2e_option_handle_stock" title="Handle stock" class=" required-entry select">
							...
							<label for="wpl-option-create_orders" class="text_label"><?php echo __('Create orders','wplister') ?></label>
							<select id="wpl-option-create_orders" name="wpl_e2e_option_create_orders" title="Create Orders" class=" required-entry select">
							...
							<?php if ( ProductWrapper::plugin == 'woo') : ?>
							<label for="wpl-option-new_order_status" class="text_label"><?php echo __('Order status','wplister') ?></label>
							<select id="wpl-option-new_order_status" name="wpl_e2e_option_new_order_status" title="Create Orders" class=" required-entry select">
							...
							<select id="wpl-option-foreign_transactions" name="wpl_e2e_option_foreign_transactions" title="Create Orders" class=" required-entry select">
								<option value="0" <?php if ( $wpl_option_foreign_transactions != '1' ): ?>selected="selected"<?php endif; ?>><?php echo __('Skip','wplister'); ?></option>
					...
					<div class="postbox" id="OtherSettingsBox">
						...
						<div class="inside">
							...
							<!-- ## BEGIN PRO ## -->
							<?php if ( ProductWrapper::plugin == 'woo') : ?>
							<label for="wpl-local_auction_display" class="text_label"><?php echo __('Local auction display','wplister'); ?>:</label>
							<select id="wpl-local_auction_display" name="wpl_e2e_local_auction_display" title="Uninstall" class=" required-entry select">
								<option value="off" 	<?php if ( $wpl_local_auction_display == 'off'    ): ?>selected="selected"<?php endif; ?>><?php echo __('Off','wplister'); ?></option>
								<option value="always"  <?php if ( $wpl_local_auction_display == 'always' ): ?>selected="selected"<?php endif; ?>><?php echo __('Always show link to eBay','wplister'); ?></option>
								<option value="if_bid"  <?php if ( $wpl_local_auction_display == 'if_bid' ): ?>selected="selected"<?php endif; ?>><?php echo __('Only if there are bids on eBay','wplister'); ?></option>
							</select>
							<p class="desc" style="display: block;">
